...
namespace ExamAccessArrangements.Controllers
{
    public class ExamAccessArrangementsController : Controller
    {
        ...
        private readonly string sqlStudentInfo = "eea.spEAAStudentInfo_20220905LS @AY, @RefNo, @SDiD";
        private readonly string sqlEnrolmentInfo = "eea.spEAAEnrolmentInfo_20220905LS @AY, @RefNo, @SDiD";
        ...
        public IActionResult Index(string? AY, string? RefNo, string? SDiD)
        {
            ViewBag.AY = AY;
            SqlParameter p1 = new("@AY", AY);
            SqlParameter p2 = new("@RefNo", RefNo);
            SqlParameter p3 = new("@SDiD", SDiD);
